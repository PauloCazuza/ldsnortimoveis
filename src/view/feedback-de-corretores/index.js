...
import './feedback-dos-corretores.css';

import solicitacoesImovel from '../administrador/images/deal.svg'

class FeedbackCorretores extends React.Component {
            ...
            <>
                ...
                <div className="container pb-5">
                  <div className="container">
                    ...
                    <h4 className="mt-4 ml-3 mb-0 display-3 title align-text-bottom">Feedback dos Corretores</h4> </div>
                    <hr className="my"></hr>
                            ...
                            return (
                                <>
                                    <CardImovelInteressados
                                        id={item.idImovel} solicitacoes={this.state.interessesSolicitadosPorId[item.idImovel].length}
                                        interessados={this.state.interessesSolicitadosPorId[item.idImovel]}
                                    />
                                </>
                            )
                        })}
...
export default FeedbackCorretores;